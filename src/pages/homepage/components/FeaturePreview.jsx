      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            Powerful features designed specifically for Indian SMBs, replacing Excel with intelligent automation
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl shadow-2xl border-2 border-border overflow-hidden">
          <div className="flex overflow-x-auto border-b-2 border-border scrollbar-hide bg-muted/30">
            ...
            <button
              ...
              className={`flex-shrink-0 flex items-center gap-3 px-6 md:px-8 py-5 transition-all duration-300 font-semibold ${
