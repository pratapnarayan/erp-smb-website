...
const Pricing = () => {
  ...
  const testimonials = [
  {
    ...
    image: "https://img.rocket.new/generatedImages/rocket_gen_img_1ee5ff257-1763295936069.png",
    imageAlt: "Professional headshot of Indian businessman in formal blue shirt with confident smile",
    testimonial: "Switching from Excel to ERP-SMB was the best decision for our wholesale business. We now have real-time visibility into our inventory across 3 locations. The ROI was evident within the first 2 months.",
    tier: "Growth",
    metrics: [
  ...
  },
  {
    ...
    imageAlt: "Professional portrait of Indian woman in formal attire with warm smile in office setting",
    testimonial: "The GST-compliant invoicing and automated reporting have transformed our month-end processes. What used to take 3 days now takes just a few hours. The support team is incredibly responsive.",
    tier: "Enterprise",
    metrics: [
    { label: "Faster Reporting", value: "70%" },
    { label: "Cost Savings", value: "₹2.5L/year" }]
  ...
  },
  {
    ...
    imageAlt: "Professional headshot of middle-aged Indian man in business casual attire with glasses",
    testimonial: "As a growing distribution business, we needed something more robust than Tally but simpler than expensive enterprise software. ERP-SMB hit the sweet spot. The migration was smooth and the team was with us every step.",
    tier: "Growth",
    metrics: [
          ...
          <section className="py-12 md:py-16 bg-muted/30 px-4 md:px-6">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-8 md:mb-12">
                ...
                <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
                  Real results from Indian SMBs who transformed their business with ERP-SMB
                </p>
              </div>
          ...
          <section className="py-12 md:py-16 lg:py-20 bg-primary/5 px-4 md:px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join 500+ Indian SMBs who have already made the switch. Start your 14-day free trial today 
                with full access to all Growth plan features. No credit card required.
              </p>
